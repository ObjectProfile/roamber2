...
return smalltalk.withContext(function($ctx1) { 
var $1;
$1=_st(self._new())._r_g_b_((0.4),(0.4),(0.4));
return $1;
}, function($ctx1) {$ctx1.fill(self,"veryVeryLightGray",{},smalltalk.Color.klass)});},
args: [],
source: "veryVeryLightGray\x0a\x09^ self new r: 0.4 g: 0.4 b: 0.4",
messageSends: ["r:g:b:", "new"],
referencedClasses: []
}),
smalltalk.Color.klass);
...
$1=self;
return $1;
}, function($ctx1) {$ctx1.fill(self,"rtValue:",{anArgument:anArgument},smalltalk.Object)});},
args: ["anArgument"],
source: "rtValue: anArgument \x0a\x09^ self",
messageSends: [],
referencedClasses: []
}),
smalltalk.Object);
...
self._error_("Incorrect number of arguments");
return self}, function($ctx1) {$ctx1.fill(self,"rtValue:",{valueOrArray:valueOrArray},smalltalk.BlockClosure)});},
args: ["valueOrArray"],
source: "rtValue: valueOrArray\x0a\x09self numArgs = 0 ifTrue: [ ^ self value ].  \x0a\x09self numArgs = 1 ifTrue: [ ^ self value: valueOrArray ].\x0a\x09\x0a\x09\x22if I have more than 1 argument, then the valueOrArray is a collection\x22\x0a\x09valueOrArray isCollection ifFalse: [ self error: 'A block with more than one argument can only be evaluated with a collection ' ].\x0a\x09\x0a\x09self numArgs = valueOrArray size ifTrue: [ ^ self valueWithArguments: valueOrArray ]. \x0a\x09\x0a\x09self error: 'Incorrect number of arguments'",
messageSends: ["ifTrue:", "value", "=", "numArgs", "value:", "ifFalse:", "error:", "isCollection", "valueWithArguments:", "size"],
referencedClasses: []
}),
smalltalk.BlockClosure);
